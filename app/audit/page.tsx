...
const mockAuditLogs: AuditLog[] = [
  ...
  { id: "8", user: "Lechisa Bedasa", role: "Administrator", action: "Modified", module: "Settings", entity: "Tax Rate", entityId: "TAX-001", timestamp: "2026-08-12 16:30:00", ipAddress: "10.0.1.45", device: "Desktop / Chrome", location: "Muscat, Oman", status: "success", details: "Updated VAT rate configuration from 5% to 5%" },
